import { Home, Users, Settings, Info, ChevronLeft, ChevronRight, Fingerprint, Sparkles, Server, Cloud } from 'lucide-react'
...
export type PageType = 'home' | 'accounts' | 'machineId' | 'kiroSettings' | 'proxy' | 'apiManage' | 'settings' | 'about'
...
const menuItemsConfig: { id: PageType; labelKey: string; icon: React.ElementType }[] = [
  ...
  { id: 'apiManage', labelKey: 'nav.apiManage', icon: Cloud },
